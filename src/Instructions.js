  ...
  return (
    <div className="block">
      ...
      <div>
        ...
        However, those candles will burn forever; which is not likely to happen
        in the real world.
      </div>
      <br />
      <div>
      ...
      <ul>
        <li>
          Create a state that will hold the value of the candle's height in your
          component. Set its default value to 80.
        </li>
        <li>
          The height of the candle is controlled by the candle class in the CSS
          file. Target the height value and set it to reflect your newly created
          state
        </li>
        <li>
        ...
        <li>
          ...
          so you don't burn this sandbox down! For this, you should conditionaly
          render (or not) the whole candle based on its height
        </li>
        <li>
          We don't want to be stuck in the dark, do we? Change the "Make candle
          smaller" button to "Replace with new candle", and implement a function
          that will refresh the candle to its original state
        </li>
      </ul>
      <a
        target="_blank"
